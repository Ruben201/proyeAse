...
builder.Services.ConfigureApplicationCookie(options =>
{
    ...
    //options.LoginPath = "/Cargos/LoginCargo"; //Página de autenticación
    options.LoginPath = "/Conductor/LoginConductor"; //Página de autenticación
    options.SlidingExpiration = true;
    options.ExpireTimeSpan = TimeSpan.FromMinutes(20); //Después de 20 minutos expirar
});
